...
public class RawMapreduce {
  ...
  public static void main( String[] args ) throws Exception {
    Path transactions = new Path("/user/path/transactions");
    Path users = new Path("/user/path/users");
    Path staging = new Path("/user/path/staging");
    Path output = new Path("/user/path/output");
